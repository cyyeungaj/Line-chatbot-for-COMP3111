...
@Slf4j
public class showAnswerState extends UserInterface {
	
	public showAnswerState ( String userReply) {
		int userNumInput = 0  ;
		 try {
		 ...
		 super.setMessage(new JDBCFaqManager().getAnswerByQuestionNo(userNumInput)+"\n1.Got back to menu interface\n2.Continue FAQ\n") ;	
	}
	...
	public void processInput( chatbotController controller, String userReply , Event event ) {
		...
		super.setMessage("Invalid input , please type 1 or 2") ; 
	}
